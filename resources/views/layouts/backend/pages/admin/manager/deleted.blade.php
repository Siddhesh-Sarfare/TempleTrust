...
@section('page-content')
    <div class="main-container container">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="text-primary mr-auto">Deleted संयुक्त व्यवस्थापक</h1>
                </div>
            </div>
        </div>
        <!-- /heading -->
                    ...
                    <tr>
                        ...
                        <td class="align-middle">{{ $item->name }}</td>
                            <td class="align-middle">
                                <form method="POST" id="restore-data-form" action="{{ route('admin.manager.deleted.restore', $item->id) }}" hidden>
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                </form>
