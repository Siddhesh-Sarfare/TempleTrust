...
<div class="main-container container">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h1 class="text-primary mr-auto">Contact</h1>
            </div>
            <div class="col d-flex justify-content-end align-self-center">
                <a href="{{ route('admin.contact.create') }}" class="btn btn-outline-primary pull-right">Create New</a>
            </div>
        </div>
    </div>
    <!-- /heading -->
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="align-middle">
                    <a href="{{ route('admin.contact.edit', $item->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
                    <form method="POST" class="delete-data-form" action="{{ route('admin.contact.delete', $item->id) }}" hidden>
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                    </form>
