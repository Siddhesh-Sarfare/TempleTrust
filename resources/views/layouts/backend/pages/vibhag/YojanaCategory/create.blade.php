    ...
    <div class="main-container container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('vibhag.YojanaCategory.store') }}">
                    <div class="card text-white bg-dark mb-3">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col">
                                    <!-- submit -->
                                    <a href="{{ route('vibhag.YojanaCategory.index') }}" class="btn btn-block btn-danger">Cancel</a>
                                    <!-- /submit -->
                                </div>
                            </div>
                        </div>
